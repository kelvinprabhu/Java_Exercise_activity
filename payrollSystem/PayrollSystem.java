...
public class PayrollSystem {
    public static void main(String[] args) {
        ...
        new HourlyEmployee(1, "Anto", "Assistant Head Of Department ", 20.5, 40).displayInfo();
        new SalariedEmployee(2, "Kelvin", "Research Prof", 4000).displayInfo();
        new ExecutiveEmployee(3, "Prabhu", "Head of Department", 8000, 15).displayInfo();
    }
}